...
try:
  ...
  class BetaObjectTrackerServicer(object):
  ...
  class BetaObjectTrackerStub(object):
    """The Beta API is deprecated for 0.15.0 and later.
  ...
  def beta_create_ObjectTracker_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    """The Beta API is deprecated for 0.15.0 and later.
    ...
    request_deserializers = {
      ('object_tracking.ObjectTracker', 'ReportLocation'): ClientInfo.FromString,
    }
    response_serializers = {
      ('object_tracking.ObjectTracker', 'ReportLocation'): Location.SerializeToString,
    }
    method_implementations = {
      ('object_tracking.ObjectTracker', 'ReportLocation'): face_utilities.unary_stream_inline(servicer.ReportLocation),
    }
  ...
  def beta_create_ObjectTracker_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    """The Beta API is deprecated for 0.15.0 and later.
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('object_tracking.ObjectTracker', 'ReportLocation'): ClientInfo.SerializeToString,
    }
    response_deserializers = {
      ('object_tracking.ObjectTracker', 'ReportLocation'): Location.FromString,
    }
    cardinalities = {
    ...
    return beta_implementations.dynamic_stub(channel, 'object_tracking.ObjectTracker', cardinalities,
