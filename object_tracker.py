...
class ObjectTracker:
    def __init__(self, url, location_server, middle, bgr_color, hsv_range, resize_width, display_image=False):
        ...
        self._resized_width = resize_width
    ...
    def start(self):
        ...
        while self._cam.is_open() and not self._finished:
            ...
            frame = imutils.resize(frame, width=self._resized_width)
            ...
            if max_contour != -1:
                ...
                if self._display_image:
                    ...
                    text += ' Image: {0}, {1}'.format(img_x, img_y)
            else:
                img_x = -1
                img_y = -1
            ...
            # Display images
            if self._display_image:
                cv2.putText(frame, text, self._cam.text_loc(), self._cam.text_font(), self._cam.text_size(), utils.RED,
                            1)
